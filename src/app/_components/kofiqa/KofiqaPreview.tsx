      ...
      {news.length > 0 &&
        news.map((item) => (
          <Link
            ...
            key={item.id}
            className="flex flex-col sm:flex-row sm:items-center sm:justify-between py-2.5 sm:py-3 border-b border-gray-200 hover:bg-gray-50 transition-colors gap-2 sm:gap-0"
          >
